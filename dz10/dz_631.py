...
class RationalList:
    ...
    def append(self, item):
        if isinstance(item, (Rational, int)):
            ...
            if not any(r['n'] == item['n'] and r['d'] == item['d'] for r in self._data):
                self._data.append(item)
        else:
            raise ValueError("Елемент має бути Rational або цілим числом")
    ...
    def __add__(self, other):
        ...
        if isinstance(other, RationalList):
            ...
            raise ValueError("Операнд має бути RationalList, Rational або цілим числом")
        return new_list
    ...
    def __iter__(self):
        ...
        self._iterator = iter(sorted_data)
        return self
